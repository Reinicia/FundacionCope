<?php 
	...
	*/
	...
	function _trackableshare_process($content, $excerpt = false, $page_url = false, $page_title = false) {
		...
		'email.png' => array('url'=>'mailto:?subject=Espero que te interese %url%', 'popup'=>'false'),
		...
		'plusone.png' => array('url'=>'https://plusone.google.com/_/+1/confirm?hl=es&url=%url%&title=%title%', 'popup'=>'550x350')
		);
		...
		if(($fblike_display == 'top' || $fblike_display == 'bottom') && !$fbjs) {
			echo '<div id="fb-root"></div><script src="http://connect.facebook.net/es_ES/all.js#appId=20320310172&amp;xfbml=1"></script>';
			if($google = 1) {
